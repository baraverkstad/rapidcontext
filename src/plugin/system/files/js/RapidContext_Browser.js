...
(function (window) {
    ...
    /**
     * List of all required browser features (ie. Chrome 86+, Firefox 80+, Safari 14+).
     *
     * @name REQUIRED
    ...
    var REQUIRED = [
        ...
        { test: "'activeElement' in document", name: "document.activeElement" },
        ...
        { test: "'noModule' in HTMLScriptElement.prototype", name: "ES modules (script element)" },
    ...
    var OPTIONAL = [
        ...
        // { test: "HTMLScriptElement.supports('module')", name: "ES module (script element, modern test)", },
        ...
        // { test: "'unicodeSets' in RegExp.prototype", name: "regexp unicodeSets" },
        "selector(:has(*))",
