 ...
 * the default widgets in the RapidContext.Widget namespace are defined
...
RapidContext.Widget.Classes = {
    Button: RapidContext.Widget.Button,
    Dialog: RapidContext.Widget.Dialog,
    Field: RapidContext.Widget.Field,
    FileStreamer: RapidContext.Widget.FileStreamer,
    Form: RapidContext.Widget.Form,
    FormValidator: RapidContext.Widget.FormValidator,
    Icon: RapidContext.Widget.Icon,
    NavigationBar: RapidContext.Widget.NavigationBar,
    Overlay: RapidContext.Widget.Overlay,
    Popup: RapidContext.Widget.Popup,
    Pane: RapidContext.Widget.Pane,
    ProgressBar: RapidContext.Widget.ProgressBar,
    TabContainer: RapidContext.Widget.TabContainer,
    Table: RapidContext.Widget.Table,
    TableColumn: RapidContext.Widget.TableColumn,
    TextArea: RapidContext.Widget.TextArea,
    TextField: RapidContext.Widget.TextField,
    Tree: RapidContext.Widget.Tree,
    TreeNode: RapidContext.Widget.TreeNode,
    Wizard: RapidContext.Widget.Wizard
};
