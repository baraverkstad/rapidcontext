...
(function (window) {
     ...
     * }
     */
    const error = show.bind(null, "error");
     ...
     */
    const warning = show.bind(null, "warning");
     ...
     */
    const success = show.bind(null, "success");
    ...
    const api = RapidContext.UI.Msg || (RapidContext.UI.Msg = {});
    Object.assign(api, { error, warning, success, info });
