...
(function (window) {
     ...
     * @memberof RapidContext.UI.Event
     */
    function on(src, event, selector, listener, opts) {
     ...
     * @memberof RapidContext.UI.Event
     */
    function once(src, event, selector, listener, opts) {
     ...
     * @memberof RapidContext.UI.Event
     */
    function off(src, event, selector, listener) {
        if (selector != null && typeof(selector) != "string") {
            listener = selector;
            selector = null;
        }
    ...
    const api = RapidContext.UI.Event = Event;
    Object.assign(api, { on, once, off, emit });
