...
public class AuthHelper {
     ...
     */
    public static String createProcToken(User user, Session session, String appId, String procId) {
    ...
    public static String validateProcToken(String token, String procId) {
        ...
        if (user == null || session == null) {
            throw new SecurityException("invalid procedure token: user or session not found");
        }
        String secret = user.passwordHash();
        Dict payload = Token.validateJwt(secret, token);
