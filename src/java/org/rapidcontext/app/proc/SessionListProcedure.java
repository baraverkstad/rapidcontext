...
public class SessionListProcedure implements Procedure, Restricted {
     ...
     */
    public static final String NAME = "System.Session.List";
    ...
    /**
     * Creates a new session list procedure.
     */
    public SessionListProcedure() {
        defaults.seal();
    }
    ...
    public String getDescription() {
        return "Returns a list of all currently active user sessions.";
    }
    ...
    public Object call(CallContext cx, Bindings bindings)
        ...
        iter = SessionManager.getActiveSessions().iterator();
        while (iter.hasNext()) {
            session = (HttpSession) iter.next();
            res.add(SessionCurrentProcedure.getSessionData(session));
        }
        return res;
    }
}
