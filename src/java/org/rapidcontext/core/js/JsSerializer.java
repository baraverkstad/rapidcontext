...
public class JsSerializer {
    ...
    /**
     * Checks if a character is a valid JavaScript identifier start.
     *
     * @param c              the character to check
     *
     * @return true if the character is valid, or
     *         false otherwise
     */
    // TODO: Method should probably not be public
    ...
    /**
     * Checks if a character is a valid JavaScript identifier part.
     *
     * @param c              the character to check
     *
     * @return true if the character is valid, or
     ...
     *
     * @return true if the string was a valid identifier, or
     *         false otherwise
     */
