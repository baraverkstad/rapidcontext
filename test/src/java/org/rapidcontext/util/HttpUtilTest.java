...
public class HttpUtilTest {
    ...
    public void testBrowserInfo() {
        ...
        assertThat(HttpUtil.Helper.browserInfo(ua), startsWith("Chrome 41.0.2228.0, Windows NT 6.1, Desktop"));
        ua = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2062.124 Safari/537.36";
        assertThat(HttpUtil.Helper.browserInfo(ua), startsWith("Chrome 37.0.2062.124, Mac OS X 10.10.1, Desktop"));
        ...
        assertThat(HttpUtil.Helper.browserInfo(ua), is("Chrome 18.0.1025.133, Android 4.0.4, Mobile"));
        ...
        assertThat(HttpUtil.Helper.browserInfo(ua), is("Chrome 47.0.2526.83, Android 5.1.1, Mobile"));
        ...
        assertThat(HttpUtil.Helper.browserInfo(ua), is("Chrome iOS 19.0.1084.60, iOS 5.1.1, iPhone"));
        ...
        assertThat(HttpUtil.Helper.browserInfo(ua), startsWith("MSIE 6.0, Windows NT 5.1, Desktop"));
        ua = "Mozilla/5.0 (compatible; MSIE 7.0; Windows NT 6.0; en-US))";
        assertThat(HttpUtil.Helper.browserInfo(ua), startsWith("MSIE 7.0, Windows NT 6.0, Desktop"));
        ua = "Mozilla/5.0 (compatible; MSIE 8.0; Windows NT 5.1; Trident/4.0; .NET CLR 1.1.4322; .NET CLR 2.0.50727)";
        assertThat(HttpUtil.Helper.browserInfo(ua), startsWith("MSIE 8.0, Windows NT 5.1, Desktop"));
        ua = "Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; WOW64; Trident/5.0; chromeframe/12.0.742.112)";
        assertThat(HttpUtil.Helper.browserInfo(ua), startsWith("MSIE 9.0, Windows NT 6.1, Desktop"));
        ua = "Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 7.0; InfoPath.3; .NET CLR 3.1.40767; Trident/6.0; en-IN)";
        assertThat(HttpUtil.Helper.browserInfo(ua), startsWith("MSIE 10.0, Windows NT 7.0, Desktop"));
        ua = "Mozilla/5.0 (Windows NT 6.3; Trident/7.0; rv:11.0) like Gecko";
        assertThat(HttpUtil.Helper.browserInfo(ua), startsWith("MSIE 11.0, Windows NT 6.3, Desktop"));
        ua = "Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko";
        assertThat(HttpUtil.Helper.browserInfo(ua), startsWith("MSIE 11.0, Windows NT 6.1, Desktop"));

        // Firefox
        ua = "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:40.0) Gecko/20100101 Firefox/40.1";
        assertThat(HttpUtil.Helper.browserInfo(ua), startsWith("Firefox 40.1, Windows NT 6.1, Desktop"));
        ua = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10.6; rv:25.0) Gecko/20100101 Firefox/25.0";
        assertThat(HttpUtil.Helper.browserInfo(ua), startsWith("Firefox 25.0, Mac OS X 10.6, Desktop"));
        ua = "Mozilla/5.0 (X11; Linux i686 on x86_64; rv:10.0) Gecko/20100101 Firefox/10.0";
        assertThat(HttpUtil.Helper.browserInfo(ua), startsWith("Firefox 10.0, Linux i686 on x86_64, Desktop"));
        ua = "Mozilla/5.0 (Android 4.4; Mobile; rv:41.0) Gecko/41.0 Firefox/41.0";
        assertThat(HttpUtil.Helper.browserInfo(ua), startsWith("Firefox 41.0, Android 4.4, Mobile"));
        ua = "Mozilla/5.0 (Android 4.4; Tablet; rv:41.0) Gecko/41.0 Firefox/41.0";
        assertThat(HttpUtil.Helper.browserInfo(ua), startsWith("Firefox 41.0, Android 4.4, Tablet"));
        ...
        assertThat(HttpUtil.Helper.browserInfo(ua), is("Firefox iOS 1.0, iOS 8.3, iPhone"));
        ...
        assertThat(HttpUtil.Helper.browserInfo(ua), is("Firefox iOS 1.0, iOS 8.3, iPad"));

        // Safari
        ua = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A";
        assertThat(HttpUtil.Helper.browserInfo(ua), startsWith("Safari 7.0.3, Mac OS X 10.9.3, Desktop"));
        ua = "Mozilla/5.0 (Windows; U; Windows NT 6.1; ko-KR) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/533.20.27";
        assertThat(HttpUtil.Helper.browserInfo(ua), startsWith("Safari 5.0.4, Windows NT 6.1, Desktop"));
        ...
        assertThat(HttpUtil.Helper.browserInfo(ua), is("Safari 9.0, iOS 9.2, iPhone"));
        ...
        assertThat(HttpUtil.Helper.browserInfo(ua), is("Safari 8.0, iOS 9.0, iPad"));

        // Unknown
        ua = "curl/7.9.8 (i686-pc-linux-gnu) libcurl 7.9.8 (OpenSSL 0.9.6b) (ipv6 enabled)";
        assertNull(HttpUtil.Helper.browserInfo(ua));
